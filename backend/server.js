...
// // Serve static images from the `backend/generated_images` folder
// // app.use("/generated_images", express.static(path.join(__dirname, "backend", "generated_images")));
...
//     }
//     console.log(results)
//     // Send the full URL to the images
//     res.json(results.map((row) => `${row.path}`));
//   });
// });
